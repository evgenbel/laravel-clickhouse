...
namespace Evgenbel\LaravelClickHouse\Database\Eloquent;
...
class Builder
{
     ...
     *
     * @var \Evgenbel\LaravelClickHouse\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \Evgenbel\LaravelClickHouse\Database\Eloquent\Model
     */
    protected $model;
